...
landscape_name <- "Upper Peninsula of Michigan"

shp <- st_read("inputs/up_cntys.gpkg") %>% 
...
# accessible versions from Sarah Hagen for maps and charts
...
# bps
bps_majority_hex <- exact_extract(LF2020_BPS_CONUS, hex_grid_clipped, 'majority', append_cols = "index") %>%
...
# evt
evt_majority_hex <- exact_extract(LF2024_EVT_CONUS, hex_grid_clipped, 'majority', append_cols = "index") %>%
...
# evc
evc_majority_hex <- exact_extract(LF2024_EVC_CONUS, hex_grid_clipped, 'majority', append_cols = "index") %>%
...
# evh
evh_majority_hex <- exact_extract(LF2024_EVH_CONUS, hex_grid_clipped, 'majority', append_cols = "index") %>%
...
st_write(hexs_bps_evt_evc_evh, "outputs/bps_evt_evc_evh_hexs.shp", delete_layer = TRUE)
